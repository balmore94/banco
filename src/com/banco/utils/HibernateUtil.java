	...
	public static SessionFactory getSessionFactory() {
		if (sessionFactory == null) {
			try {
				...
				settings.put(Environment.URL, "jdbc:mysql://localhost:3306/si_banco?useSSL=false");
				...
				configuration.addAnnotatedClass(TpTransaccion.class);
				configuration.addAnnotatedClass(Transacciones.class);
